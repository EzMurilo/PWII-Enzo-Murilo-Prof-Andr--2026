 ...
 * -Prenche novamente os campos em caso de erro
 */
 ...
 //Valores padrao (mantém oque o usuario digitou em caso de erro)
...
if(empty($assunto)) {
    $erros['assunto'] = ' O Campo Assunto é Obrigatorio.';
}
if(empty($mensagem)){
    $erros['mensagem'] = 'O Campo Mensagem é Obrigatorio';
 ...
 if(empty($erros)){
    ...
    /**
     * Exemplos de Envio por E-mail (Requer Servidor COnfigurado com SMTP/mail());
     * 
     * $destinario = "seuemail@exemplo.com";
     * $cabecalhos = "From: email_limpo";
     * $corpo      = "Nome: $nome_limpo\n\nMensagem:\n$mensagem_limpa";
     * mail($destinatario, $assunto_limpo, $corpo, $cabecalho);
     * 
     * Voce tambem pode salvar em um banco de dados  usando POO, por exemplo.
     */
    ...
    <div class= "container">
        ...
        <?php if ($sucesso): ?>
            ...
            <div class="campo">
                ...
                value="<?= htmlespecialchars($nome, ENT_QUOTES, 'UTF-8') ?>"
                >
            ...
            <div class="campo">
             ...
             <div class="assunto">
                ...
                value="<?= htmlspecialchars($mensagem, ENT_QUOTES, 'UTF-8') ?>"</textarea>
